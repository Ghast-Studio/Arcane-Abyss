...
import net.headnutandpasci.arcaneabyss.entity.custom.slime.AbstractRangedSlime;
...
public class DarkRedSlimeEntity extends AbstractRangedSlime {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(2, new ProjectileAttackGoal(this, 1.0, 13, 10.0F));
