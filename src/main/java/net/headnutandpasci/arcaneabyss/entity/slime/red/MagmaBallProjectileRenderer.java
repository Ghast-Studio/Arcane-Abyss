...
public class MagmaBallProjectileRenderer extends EntityRenderer<MagmaBallProjectile> {
    ...
    public MagmaBallProjectileRenderer(EntityRendererFactory.Context context) {
        super(context);
    ...
    protected int getBlockLight(MagmaBallProjectile witherSkullEntity, BlockPos blockPos) {
        return 15;
    }

    public void render(MagmaBallProjectile witherSkullEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    public Identifier getTexture(MagmaBallProjectile witherSkullEntity) {
        return TEXTURE;
    }
}
