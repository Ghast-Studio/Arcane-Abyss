...
public class SlimeviathanProjectileRenderer extends EntityRenderer<SlimeviathanProjectileEntity> {
    ...
    public SlimeviathanProjectileRenderer(EntityRendererFactory.Context context) {
        super(context);
    ...
    protected int getBlockLight(SlimeviathanProjectileEntity witherSkullEntity, BlockPos blockPos) {
        return 15;
    }

    public void render(SlimeviathanProjectileEntity witherSkullEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    public Identifier getTexture(SlimeviathanProjectileEntity witherSkullEntity) {
        return TEXTURE;
    }
