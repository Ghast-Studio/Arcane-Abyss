...
public class BlueSlimeRenderer extends MobEntityRenderer<BlueSlimeEntity, SlimeEntityModel<BlueSlimeEntity>> {
    private static final Identifier TEXTURE = new Identifier("textures/entity/slime/blueslime.png");
    ...
    public Identifier getTexture(BlueSlimeEntity entity) {
        return new Identifier(ArcaneAbyss.MOD_ID, "textures/entity/blueslime.png");
    }
